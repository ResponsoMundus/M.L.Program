...
try:
    Draw(pred, finance_features, poi, mark_poi=False, name="clusters_with_2_features.pdf", f1_name=feature_1, f2_name=feature_2)
    # Draw(pred, finance_features, poi, mark_poi=False, name="clusters_with_3_features.pdf", f1_name=feature_1, f2_name=feature_2)
except NameError:
